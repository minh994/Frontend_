...
const product = {
  name: "Áo thun cơ bản 6 cái",
  price: "1196VND",
  href: "#",
  breadcrumbs: [
    { id: 1, name: "Áo nam", href: "#" },
  ...
  highlights: [
    ...
    "Được nhuộm bằng màu độc quyền của chúng tôi",
    "100% cotton siêu mềm",
  ],
  details:
    'Bộ 6 bao gồm hai áo phông cơ bản màu đen, hai màu trắng và hai màu xám thạch nam. Hãy đăng ký dịch vụ đăng ký của chúng tôi và trở thành người đầu tiên nhận được các màu sắc mới, thú vị, chẳng hạn như phiên bản giới hạn "Xám than" sắp ra mắt của chúng tôi.',
};
          ...
          <div className="lg:col-span-1 mx-auto max-w-2xl px-4 pb-16 sm:px-6  lg:max-w-7xl  lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl tracking-tight text-gray-900 mt-6">
                ...
                {customersProduct.product?.price}VND
                </p>
                <p className="opacity-50 line-through">
                {customersProduct.product?.discountedPrice}VND
                </p>
                <p className="text-green-600 font-semibold">
                  {customersProduct.product?.discountPersent}%Giảm giá
                </p>
              </div>
              ...
              <div className="mt-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60 text-sm">42807 Đánh giá</p>
            ...
            <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
              ...
              <div>
                <h3 className="sr-only">Miêu tả</h3>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3 pb-10">
                  ...
                  <p className="opacity-60">42807 Đánh giá</p>
                </div>
                <Box>
                  <Grid
                    container
