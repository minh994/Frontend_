...
export const createReview = (resData) => {
  ...
  return async (dispatch) => {
    try {
      const response = await api.post(`${API_BASE_URL}/api/reviews/create`, 
        resData);
...
export const getAllReviews = (productId) => {
  return async (dispatch) => {
    try {
      const response = await api.get(`${API_BASE_URL}/api/reviews/product/${productId}`);
...
export const createRating = (resData) => {
  return async (dispatch) => {
    try {
      const response = await api.post(`${API_BASE_URL}/api/ratings/create`,resData);
...
export const getAllRatings = (productId) => {
  ...
  return async (dispatch) => {
    try {
      const response = await api.get(`${API_BASE_URL}/api/ratings/product/${productId}`, {
